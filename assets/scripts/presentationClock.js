...
function setTime(){
    ...
    hours = hours % 12;
    document.getElementById("clockHour").innerHTML =  (hours ? hours : 12) ; // the hour '0' should be '12'
    document.getElementById("clockMinute").innerHTML = (minutes < 10 ? '0'+minutes : minutes) 
