...
//   }
  ...
  timerSection.innerHTML += '<div class="timer" index="'+countDowns.length+'"><div class="timerValues"><div class="timeSection timerHour"></div><div class="timeSection timerMinute"></div> <div class="timeSection timerSecond"></div></div><div class="buttons"><i class="fas fa-undo-alt resetTimer" onclick="resetTimer(this)"></i><i class="far fa-window-close closeTimer" onclick="closeTimer(this)"></i><i class="fas fa-pause closeTimer" onclick="toggleTimer(this)"></i></div><div class="timerLabel">'+document.getElementById("timerValueLabel").value+'</div></div>';
...
setInterval(updateCountdownValue,500);